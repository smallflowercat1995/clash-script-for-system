        ...
        elementValue: function (b) {
          ...
          return "radio" === f || "checkbox" === f
            ...
            ? b.validity.badInput
              ? "NaN"
              : e.val()
            : ((c = g ? e.text() : e.val()), "file" === f ? ("C:\\fakepath\\" === c.substr(0, 12) ? c.substr(12) : ((d = c.lastIndexOf("/")), d >= 0 ? c.substr(d + 1) : ((d = c.lastIndexOf("\\")), d >= 0 ? c.substr(d + 1) : c))) : "string" == typeof c ? c.replace(/\r/g, "") : c);
        },
        check: function (b) {
          ...
          for (d in g) {
            ...
            try {
              ...
              throw (
                (this.settings.debug && window.console && console.debug("Exception occurred when checking element " + b.id + ", check the '" + e.method + "' method.", k),
