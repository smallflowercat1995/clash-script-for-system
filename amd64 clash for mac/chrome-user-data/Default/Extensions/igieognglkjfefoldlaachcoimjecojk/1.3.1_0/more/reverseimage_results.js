...
$(document).ready(function () {
  ...
  //console.debug("results.js popup is:" + popup);
  //console.debug("results.js background is:" + background);
  //console.debug("results.js background_search is:" + background_search);
  //console.debug("results.js verify is:" + verify);
  if (popup == -1) {
    if (background > 0) {
      loadCount = 0;
...
function loadMore(page) {
  ...
  chrome.runtime.sendMessage({ type: "load_more", keyword: keyword, url: keyword, page: page, searchType: searchType }, function (response) {
