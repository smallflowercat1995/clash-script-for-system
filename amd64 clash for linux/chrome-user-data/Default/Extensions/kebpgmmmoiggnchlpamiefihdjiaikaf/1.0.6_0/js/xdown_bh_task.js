...
function XDownHandshakeTask (id)
{
    XDownIpcTask.call (this, id, "handshake");
    this.handshake = new Object;
    this.handshake.api_version = "1";
    this.handshake.browser = window.browserName;
}

function XDownShowSettingsTask (id)
{
    XDownIpcTask.call (this, id, "show_settings");
}

function XDownApiRequestsTask (id)
{
    XDownIpcTask.call (this, id, "api_requests");
    this.api_requests = {}
}

function XDownCreateDownloadsTask (id)
{
    
    XDownIpcTask.call (this, id, "create_downloads");
...
function XDownBrowserProxyTask (id)
{
    XDownIpcTask.call (this, id, "browser_proxy");
...
function XDownWindowTask (id)
{
    XDownIpcTask.call (this, id, "window");
...
function XDownVideoSnifferTask (id)
{
    XDownIpcTask.call (this, id, "video_sniffer");
...
function XDownSniffDllIsVideoFlashRequest(
...
function XDownSniffDllCreateVideoDownloadFromUrlRequest(
	webPageUrl, frameUrl, swfUrl,
	flashVars, otherSwfUrls, otherFlashVars)
{
...
function XDownNetworkRequestNotification (id, type)
{
    console.log('==XDownNetworkRequestNotification==',id);
    XDownIpcTask.call (this, id, "network_request_notification");
    this.network_request_notification = new Object;
    this.network_request_notification.type = type;
}

function XDownNewNetworkRequestNotification (id)
{
    XDownNetworkRequestNotification.call (this, id, "new");
...
function XDownNetworkRequestActivityNotification (id)
{
    XDownNetworkRequestNotification.call (this, id, "activity");   
...
function XDownNetworkRequestResponseNotification (id)
{
    XDownNetworkRequestNotification.call (this, id, "response");   
...
function XDownNetworkRequestResponseDataNotification (id)
{
    XDownNetworkRequestNotification.call (this, id, "response_data");
...
function XDownNetworkRequestResponseCompleteNotification (id)
{
    XDownNetworkRequestNotification.call (this, id, "response_complete");   
...
function XDownBrowserDownloadStateReport (id)
{
    XDownIpcTask.call (this, id, "browser_download_state_report");
